...
class Linguee:
    ...
    def extract_translation_sortablemg_featured(self, input_html):
    ...
    def extract_lemma_featured(self, input_html, input_word):
        """
        ...
        for translation_sortablemg_featured in translation_lines:
            translation_sortablemg_featured_list.append(
                self.extract_translation_sortablemg_featured(translation_sortablemg_featured))
    ...
    def translate(self, input_word):
        ...
        for lemma in result_featured:
            entry_list = self.extract_lemma_featured(lemma, input_word)
